...
const ProfileScreen = ({ navigation }) => {
  // Tambahkan tombol back di atas header
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.profileHeader}>
        ...
        <View style={styles.profileInfo}>
          ...
          <Text style={styles.username}>@alessandrablair</Text>
          <Text style={styles.bio}>
            Hello! I'm Alessandra from Italy 🇮🇹. I love cooking and sharing my favorite recipes.
          </Text>
        </View>
        <TouchableOpacity
  ...
  <View style={styles.recipeCard}>
    ...
    <View style={styles.recipeContent}>
      ...
      <Text style={styles.recipeDetails}>
        {recipe.ingredients} Ingredients • {recipe.time}
      </Text>
    </View>
  </View>
);
